...
| <a name="input_datadog_agent_image"></a> [datadog\_agent\_image](#input\_datadog\_agent\_image) | DataDog agent image to use | <pre>object({<br>    registry : optional(string, "public.ecr.aws/datadog/agent"),<br>    tag : optional(string, "latest")<br>  })</pre> | <pre>{<br>  "registry": "public.ecr.aws/datadog/agent",<br>  "tag": "latest"<br>}</pre> | no |
