...
| <a name="input_github_actions_roles"></a> [github\_actions\_roles](#input\_github\_actions\_roles) | Roles to be used by Github Actions to perform Happy CI. | <pre>list(object({<br>    name = string<br>    arn  = string<br>  }))</pre> | `[]` | no |
