...
| <a name="input_oidc_config"></a> [oidc\_config](#input\_oidc\_config) | OIDC configuration for the happy stacks in this environment. | <pre>object({<br>    login_uri     = optional(string, ""),<br>    grant_types   = optional(set(string), ["authorization_code", "refresh_token"])<br>    redirect_uris = optional(set(string), []),<br>    teams         = optional(set(string), []),<br>    app_type      = optional(string, "web"),<br>  })</pre> | `{}` | no |
