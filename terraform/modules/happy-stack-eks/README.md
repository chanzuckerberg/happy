...
| <a name="input_exclude_host_header_match"></a> [exclude\_host\_header\_match](#input\_exclude\_host\_header\_match) | Whether to include or exclude the host names as ingress rules. These hosts can be configured outside of happy, for instance through a CloudFront distribution. | `bool` | `false` | no |
