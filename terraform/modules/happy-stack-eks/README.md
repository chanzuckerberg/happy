...
| <a name="input_tasks"></a> [tasks](#input\_tasks) | The deletion/migration tasks you want to run when a stack comes up and down. | <pre>map(object({<br>    image : string,<br>    memory : optional(string, "10Mi"),<br>    cpu : optional(string, "10m"),<br>    cmd : optional(list(string), []),<br>    args : optional(list(string), []),<br>    platform_architecture : optional(string, "amd64"), // Supported values: amd64, arm64<br>    is_cron_job : optional(bool, false),<br>    cron_schedule : optional(string, "0 0 1 1 *"),<br>  }))</pre> | `{}` | no |
