...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_batch"></a> [batch](#module\_batch) | git@github.com:chanzuckerberg/cztack//terraform/modules/aws-batch-env | v0.292.0 |
...
| <a name="input_batch_image_id"></a> [batch\_image\_id](#input\_batch\_image\_id) | AMI for batch template | `string` | n/a | yes |
