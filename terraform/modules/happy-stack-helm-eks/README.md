...
| <a name="requirement_happy"></a> [happy](#requirement\_happy) | >= 0.108 |
...
| <a name="input_features"></a> [features](#input\_features) | The features you want to enable for this stack. | <pre>map(object({<br>    name : string,<br>    enabled : bool,<br>    config : optional(map(string), {}),<br>  }))</pre> | `{}` | no |
