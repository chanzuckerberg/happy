...
| <a name="input_alb_name"></a> [alb\_name](#input\_alb\_name) | The name of the ALB to connect the k8s service to if connecting happy to an existing ALB. Only used with TARGET\_GROUP\_ONLY service types. | `string` | `""` | no |
