...
| <a name="input_sidecars"></a> [sidecars](#input\_sidecars) | List of sidecars to be deployed alongside the service | <pre>map(object({<br>    name: string<br>    image : string<br>    tag : string<br>    port : optional(number, 80),<br>    memory : optional(string, "100Mi")<br>    cpu : optional(string, "100m")<br>  }))</pre> | `[]` | no |
