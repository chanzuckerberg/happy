...
//go:generate mockgen -destination=mock_aws_ec2.go -package=testbackend github.com/aws/aws-sdk-go/service/ec2/ec2iface EC2API
...
//go:generate mockgen -destination=mock_aws_ssm.go -package=testbackend github.com/aws/aws-sdk-go/service/ssm/ssmiface SSMAPI
