...
type App struct {
	AppName string `json:"app_name" query:"app_name" validate:"required" gorm:"index:,unique,composite:metadata"`
}
...
type AppMetadata struct {
	App
	Environment string `json:"environment" query:"environment" validate:"required,valid_env" gorm:"index:,unique,composite:metadata"`
	...
	Stack string `json:"stack,omitempty" query:"stack" gorm:"default:'';not null;index:,unique,composite:metadata"`
