...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.9.19 // indirect
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.4.25 // indirect
