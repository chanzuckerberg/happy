...
func (m *MockStackServiceIface) Add(arg0 context.Context, arg1 string, arg2 ...opts.RunOption) (*stack_mgr.Stack, error) {
	m.ctrl.T.Helper()
...
func (m *MockStackServiceIface) Remove(arg0 context.Context, arg1 string, arg2 ...opts.RunOption) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
