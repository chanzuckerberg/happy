...
func decodeListAppConfigParams(args [0]string, r *http.Request) (params ListAppConfigParams, _ error) {
...
// ListAppStackParams is parameters of listAppStack operation.
type ListAppStackParams struct {
	// What page to render.
	Page OptInt
	// Item count to render per page.
	ItemsPerPage OptInt
...
func unpackListAppStackParams(packed middleware.Parameters) (params ListAppStackParams) {
	{
		key := middleware.ParameterKey{
			Name: "page",
			In:   "query",
...
func decodeListAppStackParams(args [0]string, r *http.Request) (params ListAppStackParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	// Decode query: page.
	if err := func() error {
		cfg := uri.QueryParameterDecodingConfig{
...
func decodeReadAppConfigParams(args [1]string, r *http.Request) (params ReadAppConfigParams, _ error) {
	// Decode path: id.
	if err := func() error {
...
// ReadAppStackParams is parameters of readAppStack operation.
type ReadAppStackParams struct {
	// ID of the AppStack.
	ID int64
}

func unpackReadAppStackParams(packed middleware.Parameters) (params ReadAppStackParams) {
	{
		key := middleware.ParameterKey{
			Name: "id",
			In:   "path",
...
func decodeReadAppStackParams(args [1]string, r *http.Request) (params ReadAppStackParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param, err := url.PathUnescape(args[0])
		if err != nil {
