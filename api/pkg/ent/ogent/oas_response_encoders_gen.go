...
func encodeListAppStackResponse(response ListAppStackRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ListAppStackOKApplicationJSON:
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeReadAppStackResponse(response ReadAppStackRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *AppStackRead:
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(200)
